...
public class AuthAccessTokenDto implements Serializable {
    ...
    * */
    ...
    /*
   * http://localhost:8083/spring-oauth-server/oauth/token?client_id=mobile-client&client_secret=mobile&grant_type=password&scope=read,write&username=mobile&password=mobile
   * */
    ...
    /*
     * http://localhost:8083/spring-oauth-server/oauth/token?client_id=credentials-client&client_secret=credentials-secret&grant_type=client_credentials&scope=read,write
     */
